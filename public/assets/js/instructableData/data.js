const baseDate = require('./baseData.js');
const cocktailsData = require('./cocktailsData.js');
const dessertData = require('./dessertData.js');
const dysData = require('./dysData.js');
const foodData = require('./foodData.js');
const playData = require('./foodData.js');

exports.baseDate; 
exports.cocktailsData;
exports.dessertData;
exports.dysData;
exports.foodData;
exports.playData; 

let makeChart = (root, lookfor, back) => {
        var diameter = 500;
